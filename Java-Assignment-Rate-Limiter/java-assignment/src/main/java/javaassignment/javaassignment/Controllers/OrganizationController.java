...
@RestController
@RequestMapping(APIConstants.API_BASE + APIConstants.API_ORGANIZATION)
public class OrganizationController {
  ...
  @GetMapping
  public ResponseEntity<String> getOrganizations(HttpServletRequest servletRequest)
    ...
    if (rateLimiterUtils.isAllowed(servletRequest.getHeader(HeaderConstants.HEADER_KEY_X_UUID),
        ApisIdentifier.API_GET_ORGANIZATION_ALL)) {
